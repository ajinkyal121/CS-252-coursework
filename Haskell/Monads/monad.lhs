import Data.Text.Internal.Encoding.Utf16 (validate1)
...
>   i <- mi
>   j <- mj
>   if j == 0 then fail "Div by zero" else return $ i `div` j
...
Bind seem more natural in this case because functions mincr and mdecr are taking input from previous bind and no other change is required